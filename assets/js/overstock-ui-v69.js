...
'use strict';
const overstockRiskView={supplier:'',riskShareFilter:'all',sort:'inventory_value_desc',rpFilter:'all',minExcessValue:'',maxExcessValue:'',selected:new Set()};
...
function openOverstockRiskPopup(options={}){
 ...
 $('overstockRpFilter').onchange=e=>{overstockRiskView.rpFilter=e.target.value;overstockRiskView.supplier='';overstockRiskView.riskShareFilter='all';overstockRiskView.selected.clear();d.dataset.returnScroll='0';openOverstockRiskPopup({resetScroll:true});};
